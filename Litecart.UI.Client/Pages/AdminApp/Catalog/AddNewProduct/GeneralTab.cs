...
namespace Litecart.UI.Client.Pages.AdminApp.Catalog.AddNewProduct
{
    ...
    {
        IWebElement GeneralTabElement => DriverFactory.Driver.FindElement(By.CssSelector("a[href ='#tab-general']"));

        public void OpenTab(IWebElement tabElement)
        {
            tabElement.Click();
        }
        IWebElement Status => DriverFactory.Driver.FindElement(By.CssSelector("input[name='status'][value='1']"));
